...
// Node.java: A node in a search tree. // It is task independent and supports both blind and heruistic search.
...
class Node {
	...
	LinkedList stateToNode(LinkedList ss) {
		...
		for (int i = 0; i < scnt; i++) {
			Node n = new Node((ObjectPlus) ss.get(i), this);// new succeesor
															// node
			nds.add(n);
